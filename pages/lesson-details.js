        ...
        <div className="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row g-6">
                      ...
                      <div class="card-body pt-4">
                        ...
                        <div class="d-flex flex-wrap row-gap-2">
                          <div class="me-12">
                            ...
                            <p class="text-nowrap mb-2">
                              <i class="ti ti-users me-2 align-top"></i>
                              Students: 38,815
                            </p>
                            <p class="text-nowrap mb-2">
                              <i class="ti ti-world me-2 align-bottom"></i>
                              Languages: English
                            </p>
                            <p class="text-nowrap mb-0">
                              <i class="ti ti-file me-2 align-bottom"></i>
                              Captions: Yes
                            </p>
                          </div>
                          <div>
                        ...
                        <h5>Description</h5>
                        <p class="mb-6">
                          The material of this course is also covered in my
                          other course about web design and development with
                          HTML5 & CSS3. Scroll to the bottom of this page to
                          check out that course, too! If you're already taking
                          my other course, you already have all it takes to
                          start designing beautiful websites today!
                        </p>
                        <p class="mb-6">
                          "Best web design course: If you're interested in web
                          design, but want more than just a "how to use
                          WordPress" course,I highly recommend this one." —
                          Florian Giusti
                        </p>
                        <p>
                          "Very helpful to us left-brained people: I am familiar
                          with HTML, CSS, JQuery, and Twitter Bootstrap, but I
                          needed instruction in web design. This course gave me
                          practical, impactful techniques for making websites
                          more beautiful and engaging." — Susan Darlene Cain
                        </p>
                        <hr class="my-6" />
                        <h5>Instructor</h5>
              ...
              <div class="col-lg-4">
                <div
                  class="accordion stick-top accordion-custom-button"
                  id="courseContent"
                >
